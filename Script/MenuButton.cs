    ...
    public void OnClickRandBox() // 뽑기 버튼 클릭시
    {
        ...
        if (gameManager.Crystal >= 1000)
        {
            ...
            if (rand == 1) // 전설 기물
            {
                ...
                gameManager.Player3_1.gameObject.SetActive(true); // 인게임 기물 활성화
                Info3_1Rock.gameObject.SetActive(false); // 잠금 해제
                Info3_1Txt.gameObject.SetActive(true);
            }
            else if (rand == 2 || rand == 3) // 영웅 기물
            {
                ...
                if (rand2 == 1)
                {
                    ...
                    gameManager.Player2_1.gameObject.SetActive(true);
                ...
                else if (rand2 == 2)
                {
                    ...
                    gameManager.Player2_2.gameObject.SetActive(true);
                ...
                else if (rand2 == 3)
                {
                    ...
                    gameManager.Player2_3.gameObject.SetActive(true);
            ...
            else // 희귀 기물
            {
                ...
                if (rand3 == 1)
                {
                    ...
                    gameManager.Player1_1.gameObject.SetActive(true);
                ...
                else if (rand3 == 2)
                {
                    ...
                    gameManager.Player1_2.gameObject.SetActive(true);
